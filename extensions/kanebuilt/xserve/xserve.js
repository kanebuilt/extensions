// Name: Xserve
// ID: kbXserve
// Description: Simple client-server communication for Scratch projects using WebSockets. Create your own multiplayer games, chat rooms, and more!
...
(function (Scratch) {
  ...
  const XSERVE_VERSION = '0.1.0';

  class XserveExtension {
    constructor() {
      this.ws = null;
    ...
    whenClientEvent(args) {
      ...
      const queueIndex = this._clientEventQueue.findIndex((entry) => entry.event === expectedEvent);
    ...
    downloadServerSoftware() {
      Scratch.download(
        'https://kanebuilt.github.io/extensions/extensions/kanebuilt/xserve/xserver.js',
        'xserver.js',
      );
    }
  }

  Scratch.extensions.register(new XserveExtension());
})(Scratch);
