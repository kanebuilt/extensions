...
| -------------- | -------- | ------------------------------------------------------------------------------ |
| Signalling     | `v1.1.0` | <https://kanebuilt.github.io/extensions/extensions/kanebuilt/signalling.js>    |
...
For additional documentation on the extensions in this repository, see [`docs/`](./docs/).
